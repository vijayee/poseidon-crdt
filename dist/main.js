...
class Document {
  ...
  merge(operation) {
    ...
    console.log('starting rev', revision)

    if ((revision < operations.length) && (operations[revision].id == id)) {
      revision++
      console.log('rolling forward because it was the last', revision)
      while ((revision < operations.length) && (context.has(operations[revision].id))) {
        console.log('rolling forward because we have it', revision)
    ...
    console.log('operations length before add', operations.length)
    this.add(operation)
    console.log('operations length after add', operations.length)
    if (isCurrent) {
      console.log('incremented after add', revision)
      revision++
    } else {
      context.add(id)
    }
  ...
  onEdit(text) {
    let diff = Document.getDiff(oldText, newText, cursor)
    let operations = this.diffToOps(diff)
